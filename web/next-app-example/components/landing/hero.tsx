    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-0 pb-10">
        <div className="text-center">
          ...
          {/* Subheadline */}
          <p className="mx-auto max-w-2xl text-lg sm:text-xl text-neutral-600 dark:text-neutral-400 mb-6">
          ...
          <div className="mb-6">
            <a
              href="https://ai.yoopta.dev"
              target="_blank"
              rel="noopener noreferrer"
              className="group inline-flex items-center gap-3 px-5 py-3 rounded-2xl border border-violet-500/30 bg-gradient-to-r from-violet-500/10 to-fuchsia-500/10 hover:from-violet-500/15 hover:to-fuchsia-500/15 transition-all text-sm"
            >
              ...
              <span className="text-neutral-700 dark:text-neutral-200">
                <span className="font-semibold text-violet-600 dark:text-violet-400">Yoo AI</span> — AI app builder powered by Yoopta Editor. Try it free
              </span>
              <ArrowRight className="w-3 h-3 text-violet-600 dark:text-violet-400 group-hover:translate-x-0.5 transition-transform" />
            </a>
          </div>
