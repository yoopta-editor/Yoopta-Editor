...
import { SocialMediaChatEditor } from "@/components/playground/examples/social-media-chat/social-media-chat-editor";
import { Header } from "@/components/landing/header";
import Link from "next/link";
import { Code2 } from "lucide-react";

const SOURCE_URL =
  "https://github.com/Darginec05/Yoopta-Editor/tree/main/web/next-app-example/components/playground/examples/social-media-chat/social-media-chat-editor.tsx";
