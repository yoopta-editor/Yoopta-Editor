...
const SOURCE_URL =
  "https://github.com/Darginec05/Yoopta-Editor/tree/main/web/next-app-example/components/playground/examples/word-example";

export default function WordExamplePage() {
  return (
    <div className="min-h-screen bg-neutral-100 dark:bg-neutral-900">
      <Header />
      <div className="flex justify-end px-4 py-2 border-b border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-950">
        <Link
          href={SOURCE_URL}
          target="_blank"
