...
import { CMSActionMenuList } from './cms-action-menu-list';

type CMSBlockOptionsProps = {
  open?: boolean;
...
export const CMSBlockOptions = ({ open, onOpenChange, blockId, anchor }: CMSBlockOptionsProps) => {
