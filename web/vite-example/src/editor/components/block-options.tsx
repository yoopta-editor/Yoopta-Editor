...
import { ActionMenuListComponent } from './action-menu-list';
  ...
  return (
    <>
      <BlockOptions open={open} onOpenChange={onOpenChange} anchor={anchor}>
        <BlockOptions.Content side="right" align="end" sideOffset={5}>
          <BlockOptions.Group>
      ...
      <ActionMenuListComponent placement='right-start' open={actionMenuOpen} onOpenChange={onActionMenuClose} anchor={turnIntoRef.current} />
    </>
  );
};
