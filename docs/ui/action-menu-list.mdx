...
<Frame>
  ![Action menu list screenshot](/images/action-menu-list.png)
</Frame>
...
// import { ActionMenuList, useActionMenuList, useActionMenuListActions } from '@yoopta/ui/action-menu-list';
