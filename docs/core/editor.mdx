...
The Yoopta Editor is the main component that orchestrates all plugins, marks and ui components. It provides a flexible and powerful API for building rich-text editing experiences.
