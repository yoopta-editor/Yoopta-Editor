...
3. **Themes** (`@yoopta/themes-*`) - Pre-styled plugin elements
...
Yoopta is fully open source and built with care. Integrating rich text editors into products is often painful: complex APIs, limited flexibility, or editors that don’t fit your UX. Yoopta was born from that pain. The goal is simple—give you a **headless core** for full control, plus **20+ plugins**, **ready-made UI components** (toolbars, slash menu, block actions), and **ready-made themes** (shadcn, Material) for quick start, so you can build a rich, polished editor without starting from zero. We care about developer experience and end-user experience alike. Your feedback, stars, and support help keep that focus.
