...
<span style={{ display: 'inline-block', background: '#f59e0b', color: '#fff', padding: '4px 10px', borderRadius: '9999px', fontSize: '12px', fontWeight: 600, marginBottom: '16px' }}>Beta</span>
